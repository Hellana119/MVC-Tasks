...
namespace Day3.Models.Domain
{
    public class Ticket
    {
        ...
        { 
             //new (DateTime.Now,true, Severity.low,"london", "Electronics", new Department(){Name : ""}),
        };
        public Ticket() {
            
        }

        public Ticket(DateTime createdDate, bool isClosed, Severity severity, string description, Department department) {
